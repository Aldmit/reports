...
async def cmd_start(message: types.Message, state: FSMContext):
    ...
    def get_keyboard():
            buttons = [
                # [types.InlineKeyboardButton(text="Работа с планами", callback_data="set_budgets")],
                # [types.InlineKeyboardButton(text="Работа с клиентами", callback_data="set_clients")],
                [types.InlineKeyboardButton(text="Получить статистику", callback_data="get_reports")],
            ]
